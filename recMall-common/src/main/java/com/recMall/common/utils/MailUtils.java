...
public class MailUtils {
    ...
    // 发件人邮箱地址
    private static final String emailAccount = "3013419596@qq.com"; // 这个是普通QQ邮箱
    // 发件人邮箱授权码
    private static final String emailPassword = "mnnvtmsxolxcdhea";
    ...
    public static boolean sendEmail(Set<String> emails, String title, String content) {
        ...
        try {
            ...
            message.setFrom(new InternetAddress(emailAccount, "RecMall注册服务", "UTF-8"));
            ...
            System.out.println("发送邮件失败,系统错误！" + e);
            return false;
        }
    }
