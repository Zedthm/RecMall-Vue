<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="下单者" prop="userId">
        <el-input
    ...
    <el-table v-loading="loading" :data="ordersList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="下单者" align="center" prop="userId" />
      <el-table-column label="订单状态" align="center" prop="status" />
      <el-table-column label="下单时间" align="center" prop="time" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="下单者" prop="userId">
          <el-input v-model="form.userId" placeholder="请输入下单者" />
        </el-form-item>
        <el-form-item label="下单时间" prop="time">
          <el-input v-model="form.time" placeholder="请输入下单时间" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除书籍订单编号为"' + ids + '"的数据项？').then(function() {
