...
<script>
import { listTags, getTags, delTags, addTags, updateTags } from "@/api/mall/tags";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除存储系统标签信息编号为"' + tagIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('mall/tags/export', {
        ...this.queryParams
