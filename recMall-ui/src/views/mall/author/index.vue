<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="authorList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="作者唯一标识" align="center" prop="authorId" />
      <el-table-column label="作者姓名" align="center" prop="name" />
...
<script>
import { listAuthor, getAuthor, delAuthor, addAuthor, updateAuthor } from "@/api/mall/author";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除书籍作者信息编号为"' + authorIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('mall/author/export', {
        ...this.queryParams
